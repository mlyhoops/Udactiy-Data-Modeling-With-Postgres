...
def process_song_file(cur, filepath):
    """
    This procedure reads in a song file and inserts
    data to the songs and artists tables
    Inputs:
...
def process_log_file(cur, filepath):
    """
    This procedure reads in a log file and
    inserts data to time, users and songplays tables
    Inputs:
        cur (psycopg2.cursor): The psycopg2 cursor
...
def process_data(cur, conn, filepath, func):
    """
    This procedure reads all files form the given location and
    executes the specified function
    Inputs:
        cur (psycopg2.cursor): The psycopg2 cursor
        conn (psycopg2.conneciotn): The database connection
        filepath (str): The location fo files to be processed
